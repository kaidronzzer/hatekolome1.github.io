...
<title>HATE KOLOME DASHBOARD </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Hate Kolome Online Test</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="dash.php?q=6">Results</a></li>
...
$result = mysqli_query($con,"SELECT * FROM history ORDER BY date DESC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Topic</b></td><td><b>Marks</b></td><td><b>Time</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$email = $row['email'];
	$eid = $row['eid'];
  ...
  $wrong = $row['wrong'];
    ...
    $q12=mysqli_query($con,"SELECT * FROM quiz,user WHERE eid='$eid'" )or die('Error98');
$rowcount=mysqli_num_rows($q12);	
  ...
  while($row1=mysqli_fetch_array($q12)){
    ...
    echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$title.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
    <td></td></tr>';
  }
